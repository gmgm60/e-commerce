...
@freezed
class GeneralRemoteAppFailure extends RemoteAppFailure
    with _$GeneralRemoteAppFailure {
  ...
  factory GeneralRemoteAppFailure.noConnection({required String message}) =
      _NoConnection;

  factory GeneralRemoteAppFailure.serverError({required String message}) =
      _ServerError;
...
@freezed
class GeneralLocalAppFailure extends LocalAppFailure
    with _$GeneralLocalAppFailure {
  factory GeneralLocalAppFailure.cantAccess({required String message}) =
      _CantAccess;
}
