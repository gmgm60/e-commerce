...
import '../features/cart/presentation/cubit/cart_cubit/cart_cubit.dart' as _i53;
...
import '../features/products/domain/use_cases/get_products.dart' as _i56;
...
import '../features/profile/presentation/bloc/profile_cubit/profile_cubit.dart'
    as _i52;
import 'module/dio.dart' as _i59;
import 'module/logger.dart' as _i60;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i49.OrdersCubit>(
      () => _i49.OrdersCubit(get<_i44.GetOrderUseCase>()));
  gh.factory<_i50.ProductRepo>(
      () => _i51.ProductsRepoImpl(get<_i28.ProductService>()));
  gh.factory<_i52.ProfileCubit>(
      () => _i52.ProfileCubit(get<_i45.GetUserUseCase>()));
  gh.factory<_i53.CartCubit>(() => _i53.CartCubit(
      get<_i42.GetCart>(), get<_i41.EditCart>(), get<_i4.Logger>()));
  gh.factory<_i54.ChangeLocaleUseCase>(
      () => _i54.ChangeLocaleUseCase(get<_i46.LocalizationRepository>()));
  gh.factory<_i55.GetLocaleUseCase>(
      () => _i55.GetLocaleUseCase(get<_i46.LocalizationRepository>()));
  gh.factory<_i56.GetProducts>(() => _i56.GetProducts(get<_i50.ProductRepo>()));
  gh.factory<_i57.LocaleCubit>(() => _i57.LocaleCubit(
      get<_i55.GetLocaleUseCase>(), get<_i54.ChangeLocaleUseCase>()));
  gh.factory<_i58.ProductsCubit>(
      () => _i58.ProductsCubit(get<_i56.GetProducts>()));
  return get;
}

class _$MyDioInject extends _i59.MyDioInject {}

class _$MyLoggerInject extends _i60.MyLoggerInject {}
