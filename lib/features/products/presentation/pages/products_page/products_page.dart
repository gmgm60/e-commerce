            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(product.name,style: Theme.of(context).textTheme.headline6,overflow: TextOverflow.ellipsis,maxLines: 2),
                  const Expanded(child: Text("")),
                  Text((product.price * (1-product.discount)).toStringAsFixed(2)+" "+"EGP",style: Theme.of(context).textTheme.headline6),
                  const SizedBox(height: 10,),
                  Row(
                    children: [
                      Text(product.price.toString()+context.tr.currency,style: Theme.of(context).textTheme.bodyText2!.copyWith(decoration: TextDecoration.lineThrough,)),
                      const SizedBox(width: 10,),
                      Text((product.discount * 100).toInt().toString()+context.tr.off,style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.red),),
                    ],
                  ),
